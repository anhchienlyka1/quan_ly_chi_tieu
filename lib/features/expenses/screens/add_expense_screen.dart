...
class _AddExpenseScreenState extends State<AddExpenseScreen> {
  ...
  /// Tracks whether current title was auto-generated from category selection.
  /// If true, selecting a new category will overwrite the title.
  /// If user manually edits the title, this becomes false.
  bool _isTitleAutoGenerated = false;
  ...
  void initState() {
    ...
    if (widget.expense != null) {
      ...
      initialAmount = formatter
          .formatEditUpdate(TextEditingValue.empty, val)
          .text;
    }
    ...
    if (!_isEditing) {
      ...
      // Auto-generate title for the default category
      _titleController.text = _getSuggestedTitle(_selectedCategory);
      _isTitleAutoGenerated = true;
    }
  }
  ...
  /// Returns a suggested title based on the selected category.
  String _getSuggestedTitle(ExpenseCategory category) {
    switch (category) {
      // Expense categories
        ...
        if (_isEditing && !isMockId) {
          try {
            ...
            if (e.toString().contains('404') ||
                e.toString().contains('Status code: 404')) {
              ...
              child: Column(
                ...
                children: [
                  ...
                  ProTextField(
                    ...
                    onChanged: (_) {
                      // User manually edited — stop auto-overwriting
                      _isTitleAutoGenerated = false;
                    },
                    validator: (value) {
                      if (value == null || value.isEmpty) {
    ...
    return GestureDetector(
      onTap: () {
        setState(() {
          _selectedType = type;
          _updateDefaultCategory();
          // Also update title if it was auto-generated
          if (_isTitleAutoGenerated || _titleController.text.trim().isEmpty) {
            _titleController.text = _getSuggestedTitle(_selectedCategory);
            _isTitleAutoGenerated = _titleController.text.isNotEmpty;
          }
        });
      },
          ...
          child: InkWell(
            onTap: () {
              setState(() {
                ...
                // Auto-fill title if empty or was previously auto-generated
                final currentTitle = _titleController.text.trim();
                if (currentTitle.isEmpty || _isTitleAutoGenerated) {
                  _titleController.text = _getSuggestedTitle(category);
                  _isTitleAutoGenerated = _titleController.text.isNotEmpty;
                }
              });
